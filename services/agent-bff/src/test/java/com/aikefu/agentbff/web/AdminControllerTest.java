...
class AdminControllerTest {
  ...
  void debugSearchPassesBodyThroughToKbClient() {
    ...
    AdminController c = new AdminController(kb, notify, mock(RoutingClient.class), mock(AuditClient.class), mock(ReportClient.class), mock(ToolClient.class), mock(LlmRouterClient.class), mock(AiHubClient.class));
  ...
  void dashboardDelegatesToRoutingClient() {
    ...
    AdminController c = new AdminController(kb, notify, routing, mock(AuditClient.class), mock(ReportClient.class), mock(ToolClient.class), mock(LlmRouterClient.class), mock(AiHubClient.class));
  ...
  void auditEventsDelegateToAuditClient() {
    ...
    AdminController c = new AdminController(kb, notify, mock(RoutingClient.class), audit, mock(ReportClient.class), mock(ToolClient.class), mock(LlmRouterClient.class), mock(AiHubClient.class));
