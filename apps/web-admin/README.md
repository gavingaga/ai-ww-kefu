...
- **审计流水**:坐席接入 / 关闭 / 转回 AI、主管 observe / unobserve / transfer /
  steal / whisper 的动作记录,可按 kind / actor_id / session_id / since 筛选。
  对应 `GET /v1/admin/audit/events` → audit-svc `GET /v1/audit/events`。
